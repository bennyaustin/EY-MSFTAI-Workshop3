...
# # BA
# DATA_DIR = "./data"
# train_df = pd.read_csv(os.path.join(DATA_DIR, 'porto_seguro_safe_driver_prediction_input.csv'))
...
# TODO
train, test = split_data(train_df)
data = (train, test)
model = train_model(data, parameters)
model_metrics = get_model_metrics(model, data)

# Log the metrics variable using run.log() - https://docs.microsoft.com/en-us/python/api/azureml-core/azureml.core.run.run?view=azure-ml-py#log-name--value--description-----step-none-
run.log("model_metrics", model_metrics)
